	...
	if(multifile){
		...
		nav = { 
			...
			reposition:function(view){
				...
				// DPM - trying to add this ine - remove .5 at the end of the calculation - replace wiith .1
				var transY = vertCenterFlipbooks ? ' translateY('+Math.max(window.innerHeight-(pageH*scaleAmt)-($('#viewer-options-bar').height()||0), 0)*.1 + 'px)' : '';
